...
import HorizontalScrollCard from '../../common/HorizontalScrollCard';
import SquareCardCollection from '../../common/SquareCardCollection';
import VideoCollectionOfHorizontalScrollCard from '../../common/VideoCollectionOfHorizontalScrollCard'

import { loadDiscovery } from '../../actions';
...
class DiscoverListView extends Component {
  ...
  renderRow(item) {
    switch (item.type) {
      case 'horizontalScrollCard':
        return (
          <HorizontalScrollCard data={item.data} />
        )
        break;
      case 'squareCardCollection':
        return (
          <SquareCardCollection data={item.data} />
        )
        break;
      case 'videoCollectionOfHorizontalScrollCard':
        return (<VideoCollectionOfHorizontalScrollCard data={item.data} />)
        break;
      default:
        return null;
        break;
  ...
  onEndReached() {
    if(this.props.nextPageUrl){
      this.props.dispatch(loadDiscovery(this.props.nextPageUrl));
    }
  }
...
module.exports = connect(select)(DiscoverListView);
